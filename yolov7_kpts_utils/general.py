...
from yolov7_kpts_utils.google_utils import gsutil_getsize
from yolov7_kpts_utils.metrics import fitness
from yolov7_kpts_utils.torch_utils import init_torch_seeds
...
def bbox_iou(box1, box2, x1y1x2y2=True, GIoU=False, DIoU=False, CIoU=False, eps=1e-7):
    ...
    if GIoU or DIoU or CIoU:
        ...
        if CIoU or DIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            elif CIoU:  # https://github.com/Zzh-tju/DIoU-SSD-pytorch/blob/master/utils/box/box_yolov7_kpts_utils.py#L47
...
def strip_optimizer(f='best.pt', s=''):  # from yolov7_kpts_utils.general import *; strip_optimizer()
